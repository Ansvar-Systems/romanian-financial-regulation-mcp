...
const TOOLS = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        query: { type: "string", description: "Search query in Romanian" },
        sourcebook: { type: "string", description: "Filter by sourcebook ID (e.g., ASF_NORME, BNR_REGULAMENTE). Optional." },
        status: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific Romanian financial regulation provision by sourcebook and reference.",
    inputSchema: {
      type: "object" as const,
      properties: {
        sourcebook: { type: "string", description: "Sourcebook identifier (e.g., ASF_NORME, BNR_REGULAMENTE)" },
  ...
  },
  {
    ...
    description: "List all Romanian financial regulation sourcebooks with names and descriptions.",
    inputSchema: { type: "object" as const, properties: {}, required: [] },
  },
  {
    name: "ro_fin_search_enforcement",
    description:
      "Search ASF and BNR enforcement actions — sanctiuni, avertismente, and interdictii.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Check whether a specific Romanian financial regulation provision reference is currently in force.",
    inputSchema: {
      type: "object" as const,
      properties: {
      ...
      switch (name) {
        ...
        case "ro_fin_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "Romanian Financial Regulation MCP server. Provides access to ASF norme on capital markets and BNR regulamente on prudential requirements.",
            data_sources: [

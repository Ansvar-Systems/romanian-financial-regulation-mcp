/**
 * SQLite database access layer for the Romanian Financial Regulation MCP server.
 *
 * Schema covers ASF (Autoritatea de Supraveghere Financiara) and
 * BNR (Banca Nationala a Romaniei) regulatory output:
 *   - sourcebooks        — top-level sourcebook directories (ASF_Norme, BNR_Regulamente, etc.)
 *   - provisions         — individual norme, instructiuni, regulamente, and circulare
 *   - enforcement_actions — ASF and BNR sanctions and enforcement decisions
 *
